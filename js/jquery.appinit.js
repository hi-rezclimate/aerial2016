/**
 *  Themes: Shoichi Otomo fine scratched
 *
 **/
...
function($) {
    ...
    var GrandTour = function() {
        this.VERSION = "1.0.0",
        this.AUTHOR = "Shoichi Otomo",
        this.SUPPORT = "p.chang.otokomae.0129@gmail.com",
        this.pageScrollElement = "html, body",
        this.$body = $("body")
    };

    //initializing tooltip
    GrandTour.prototype.initTooltipPlugin = function() {
        $.fn.tooltip && $('[data-toggle="tooltip"]').tooltip()
    },

    //initializing popover
    GrandTour.prototype.initPopoverPlugin = function() {
        $.fn.popover && $('[data-toggle="popover"]').popover()
    },

    //initializing nicescroll
    GrandTour.prototype.initNiceScrollPlugin = function() {
        //You can change the color of scroll bar here
        $.fn.niceScroll &&  $(".nicescroll").niceScroll({ cursorcolor: '#9d9ea5', cursorborderradius: '0px'});
    },

    //initializing knob
    GrandTour.prototype.initKnob = function() {
        if ($(".knob").length > 0) {
            $(".knob").knob();
        }
    },
    ...
    //initilizing
    GrandTour.prototype.init = function() {
    ...
    $.GrandTour = new GrandTour, $.GrandTour.Constructor = GrandTour
