...
!function($) {
    ...
    GoogleMap.prototype.createMarkers = function($container) {
        ...
        map.addMarker({
          ...
          infoWindow: {
            content: '<p> sponsor link and logo available</p>'
          }
        });
...
*/
    ...
    GoogleMap.prototype.createWithOverlay = function ($container) {
      ...
      map.drawOverlay({
        ...
        content: '<div class="gmaps-overlay">here is the space for sponsor!!<div class="gmaps-overlay_arrow above"></div></div>',
        verticalAlign: 'top',
...
//        $this.createWithPolygon('#gmaps-polygons', path);
        ...
        //street view
        $this.createWithStreetview('#panorama', 48.873746, 2.295376);

        //routes
        $this.createWithRoutes('#gmaps-route',48.873746, 2.295376);

        //types
        $this.createMapByType('#gmaps-types', 48.873746, 2.295376);

        //statu
        $this.createWithMenu('#gmaps-menu', 48.873746, 2.295376);
      });
    },
    //init
